...
% 執行粒子群算法
[optimalInput_PSO, optimalOutput_PSO] = particleswarm(fitnessFunction, 7, lb, ub, options);
...
subplot(2, 1, 2);
bar(optimalInput_PSO, 'FaceColor', 'c');
